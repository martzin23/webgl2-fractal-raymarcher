...
export default class GUIManager {
    ...
    setupWidgets(gpu, camera, storage) {
        ...
        addButton(document.getElementById("group-misc"), () => {
            storage.delete();
            location.reload();
        ...
        addIncrement(document.getElementById("group-marching"), (value) => {gpu.uniforms.max_marches = value;}, () => gpu.uniforms.max_marches, "Max marches", 1, Infinity, 25).addTooltip("Maximum ammount of steps a ray can take, heavy on performance");
        addIncrement(document.getElementById("group-marching"), (value) => {gpu.uniforms.max_bounces = value;}, () => gpu.uniforms.max_bounces, "Max bounces", 0, Infinity).addTooltip("Maximum ammount of light bounces (for Pathtraced shading mode only)");
        addSlider(document.getElementById("group-marching"), (value) => {gpu.uniforms.epsilon = value;}, () => gpu.uniforms.epsilon, "Epsilon", 0.0, 0.1, true).addTooltip("Arbitrary small value used for calculation, increase if you see glitches or lighting artifacts, decrease for higher precision");
        addSlider(document.getElementById("group-marching"), (value) => {gpu.uniforms.normals_precision = value;}, () => gpu.uniforms.normals_precision, "Normals precision", 0.0, 0.1, true).addTooltip("Precision of calculating the surface direction");
        addIncrement(document.getElementById("group-marching"), (value) => {gpu.uniforms.detail = value;}, () => gpu.uniforms.detail, "Detail", 0, Infinity).addTooltip("Complexity of a fractal, heavy on performance");
            ...
            async (value) => {
                ...
                switch (value) {
                    default: 
                        ...
                        break;
                    case 1: 
                        code = await (await fetch("./scripts/shaders/mandelbox.glsl")).text();
                        ...
                        break;
                    case 2:
                        code = await (await fetch("./scripts/shaders/mandelbulb.glsl")).text();
                        ...
                        break;
                    case 3: 
                        code = await (await fetch("./scripts/shaders/kochcurve.glsl")).text();
                        gpu.uniforms.custom_a = 1.0;
                        gpu.uniforms.custom_b = 1.0;
                        gpu.uniforms.custom_c = 1.0;
                        gpu.uniforms.custom_d = 1.0;
                        ...
                        break;
                    case 4: 
                        code = await (await fetch("./scripts/shaders/juliabulb.glsl")).text();
        ...
        addDrag(document.getElementById("group-custom"), (value) => {gpu.uniforms.custom_a = value;}, () => gpu.uniforms.custom_a, "uniforms.custom_a");
        addDrag(document.getElementById("group-custom"), (value) => {gpu.uniforms.custom_b = value;}, () => gpu.uniforms.custom_b, "uniforms.custom_b");
        addDrag(document.getElementById("group-custom"), (value) => {gpu.uniforms.custom_c = value;}, () => gpu.uniforms.custom_c, "uniforms.custom_c");
        addDrag(document.getElementById("group-custom"), (value) => {gpu.uniforms.custom_d = value;}, () => gpu.uniforms.custom_d, "uniforms.custom_d");
        addDrag(document.getElementById("group-custom"), (value) => {gpu.uniforms.custom_e = value;}, () => gpu.uniforms.custom_e, "uniforms.custom_e");
        storage.markGroup("group-custom");
        
        addDrag(document.getElementById("group-mandelbox"), (value) => {gpu.uniforms.custom_a = value;}, () => gpu.uniforms.custom_a, "Scale");
        addDrag(document.getElementById("group-mandelbox"), (value) => {gpu.uniforms.custom_b = value;}, () => gpu.uniforms.custom_b, "Folding limit");
        addDrag(document.getElementById("group-mandelbox"), (value) => {gpu.uniforms.custom_c = value;}, () => gpu.uniforms.custom_c, "Min radius");
        addDrag(document.getElementById("group-mandelbox"), (value) => {gpu.uniforms.custom_d = value;}, () => gpu.uniforms.custom_d, "Fixed radius");
        addDrag(document.getElementById("group-mandelbox"), (value) => {gpu.uniforms.custom_e = value;}, () => gpu.uniforms.custom_e, "Folding value");

        addDrag(document.getElementById("group-mandelbulb"), (value) => {gpu.uniforms.custom_a = value;}, () => gpu.uniforms.custom_a, "Power");

        addDrag(document.getElementById("group-kochcurve"), (value) => {gpu.uniforms.custom_a = value;}, () => gpu.uniforms.custom_a, "Scale");
        addDrag(document.getElementById("group-kochcurve"), (value) => {gpu.uniforms.custom_b = value;}, () => gpu.uniforms.custom_b, "Spacing");
        addDrag(document.getElementById("group-kochcurve"), (value) => {gpu.uniforms.custom_c = value;}, () => gpu.uniforms.custom_c, "Inversion");

        addDrag(document.getElementById("group-juliabulb"), (value) => {gpu.uniforms.custom_a = value;}, () => gpu.uniforms.custom_a, "Exponent");
        addDrag(document.getElementById("group-juliabulb"), (value) => {gpu.uniforms.custom_b = value;}, () => gpu.uniforms.custom_b, "Phi Multiplier");
        addDrag(document.getElementById("group-juliabulb"), (value) => {gpu.uniforms.custom_c = value;}, () => gpu.uniforms.custom_c, "Theta Multiplier");

        addSlider(document.getElementById("group-lens"), (value) => {gpu.uniforms.focus_strength = value;}, () => gpu.uniforms.focus_strength, "Blur strength", 0.0, 0.1).addTooltip("How blurred the image is when closer or further than the focus distance");
        addSlider(document.getElementById("group-lens"), (value) => {gpu.uniforms.focus_distance = value;}, () => gpu.uniforms.focus_distance, "Focus distance", 0.0, 20.0, true).addTooltip("Sets the focal point, only works when Blur strength is above 0");
        addSlider(document.getElementById("group-lens"), (value) => {gpu.uniforms.antialiasing_strength = value;}, () => gpu.uniforms.antialiasing_strength, "Antialiasing strength", 0.0, 0.001).addTooltip("Small ammount of blur applied to the image to remove sharp edges");
        ...
        addButton(document.getElementById("group-code"), async () => {
            ...
            switchSetIndex(switch_element, 0);
